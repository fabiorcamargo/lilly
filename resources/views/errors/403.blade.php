<x-base-layout :scrollspy="false">
        ...
        <div class="row mt-4">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <div class="d-flex flex-row">
                    ...
                    <h1 class="p-2 d-flex align-items-center">Code:403</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid error-content">
        <div class="">
            <h3 class="mini-text mt-4">Ooops!</h3>
            <p class="error-text mb-5 mt-1">Você não tem autorização para acessar essa página.</p>
